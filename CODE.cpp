           ...
           do{
             cout<<"\n<==================================================================================================>\n\n";
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant. My Name is INERTIA created by my Masters Of < GROUP 10 >"<<endl;
                    string phrase = "I am a virtual assistant   My Name is INERTIA.....created by my masters of group ten";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
